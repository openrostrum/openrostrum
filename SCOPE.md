...
| Visual regression tooling (Storybook, screenshot diffing) | Needs a baseline skin to diff against; the skin is deliberately a neutral stand-in until the owner designs it (`docs/rules/engineering.md` → Design system). Re-scope once a real skin exists. |
