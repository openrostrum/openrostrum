...
| House conventions — golden path, design system, auth, current-event, bounded loaders, double-submit hygiene, comments, tests | writing any code or tests | `docs/rules/engineering.md` |
